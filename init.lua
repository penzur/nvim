...
vim.keymap.set("n", "<leader>n", function()
	...
	if not has_file_bufs and vim.g.last_oil_dir then
		require("oil").open(vim.g.last_oil_dir)
	else
		require("oil").open()
	end
end)
...
vim.api.nvim_create_autocmd("BufLeave", {
	pattern = "oil://*",
	callback = function()
		vim.g.last_oil_dir = require("oil").get_current_dir()
	end,
})
...
vim.api.nvim_create_autocmd("FileType", {
	pattern = { "netrw", "NeogitStatus", "oil" },
	callback = function()
